...
public class DatabaseInitializer {
    ...
    public void init() throws IOException, URISyntaxException{
        ...
        User user1 = new User ("User 1", "123123", "USER");
        User user2 = new User ("User 2", "123123", "USER");
        User user3 = new User ("User 3", "123123", "USER");
        User user4 = new User ("User 4", "123123", "USER");
        User user5 = new User ("User 5", "123123", "USER");
        userRepo.save(admin);
        userRepo.save(user1);
        userRepo.save(user2);
        userRepo.save(user3);
